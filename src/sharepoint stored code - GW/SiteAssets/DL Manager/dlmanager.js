...
$(document).ready(function () {
    ...
    $('#pageTitle').html('<a href="/sites/admanager/">Outlook Distribution List (DL) Management System </a>');
...
function getUserForGroup(obj)
{
    ...
    selectedUsers = [];
    var address = _spPageContextInfo.webAbsoluteUrl + "/_layouts/15/Handlers/Emirates.SharePoint.ADGroupHandler.ashx?op=usersNew";
