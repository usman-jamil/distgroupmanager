...
.s4-ca {
    ...
    <script type="text/javascript" src="../SiteAssets/DL Manager/dlmanagerGW.js?version=2"></script>
    <link rel="stylesheet" type="text/css" href="../SiteAssets/DL Manager/main.css?version=2" />
    <link rel="stylesheet" type="text/css" href="../SiteAssets/DL Manager/hide.css?version=2" />
    ...
    <div id="main-content">
        ...
        <div class="clear lastTextDiv">
			<script type="text/javascript" >
				window.history.replaceState("statedata", "title", "http://gw.groupworld.emirates.com/sites/DLManager");
			</script>            
        </div>
        <div id="footer">
            <div class="wrapper">
                <div class="left w80P">
                    ...
                    <div class="copyRight">
                        ...
                        <img  src="/sites/DLManager/SiteAssets/theEmiratesGroup.png">
