...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
	...
	<div id="main-content">
		...
		<p class="" style="margin-bottom: 0px; line-height: 18px;">
					<strong>Note:&#160;</strong>
					<ul>
						<li>Updates will reflect in Outlook address book after four hours.</li>
						<li>Please contact <A href="mailto:infospace@emirates.com">Infospace Team</A> for support, queries and feedback.</li>
					</ul>
				</p>		
	</div>	
	<div>		
        ...
        <div class="wrapper">
            <div class="left w80P">
                ...
                <div class="copyRight">
                  ...
                  <IMG style="MARGIN-LEFT: 25px" src="/sites/DLManager/SiteAssets/theEmiratesGroup.png">
